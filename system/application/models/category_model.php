...
public $table = 'menu'; //Имя таблицы	
public $idkey = 'id_menu'; //Имя ID
...
public function add_second_menu()
{
    ...
    $data['link'] = $this->input->post('link');    
    $data['type'] = 2;
    $data['bind'] = $this->input->post('bind');
    $data['active'] = 1;
    $this->db->insert($this->table,$data);
}
...
public function get_category1($id)
{   
