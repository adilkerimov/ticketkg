...
$lang['deactivate_successful'] 		  	 = 'Необходима активация учетной записи.<br>';
$lang['deactivate_unsuccessful'] 	  	 = 'Невозможно деактивировать учетную запись';
$lang['activation_email_successful'] 	  	 = 'Сообщение об активации отправлено на указанную вами при регистрации почту.';
