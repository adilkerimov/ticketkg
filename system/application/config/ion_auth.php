 ...
 */
$config['site_title']                 = "LuckyStore.kg";       // Site Title, example.com
$config['admin_email']                = "admin@luckystore.kg"; // Admin Email, admin@example.com
...
$config['smtp_host'] = 'mail.getlucky.kg';
$config['smtp_user'] = 'admin@getlucky.kg';
$config['smtp_pass'] = 'kamikaze';
*/
...
$config['email_config'] = array(
	'mailtype' => 'html',
	'protocol' => 'smtp',
    'smtp_host' => 'mail.luckystore.kg',
    'smtp_user' => 'admin@luckystore.kg',
    'smtp_pass' => 'kamikaze1',
);
...
$config['message_start_delimiter'] = '<span class="info radius">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</span>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<span class="error radius">';		// Error mesage start delimiter
