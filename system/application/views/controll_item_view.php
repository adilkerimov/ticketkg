	<div class="row">
		<div class="hidden-xs hidden-sm col-md-12">
			...
			?>
			<a href="<?=base_url();?>">Главная</a>&rarr;<a href="<?=base_url();?>view/<?=$page_id2;?>"><?=$s_inst['menu'];?></a>&rarr;<a href="<?=base_url();?>view/<?=$page_id2;?>/<?=$main_info['id_item']?>"><?=$main_info['item_name']?></a>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			...
			<div id="sidebar" class="col-sm-12 col-md-6 col-lg-6" style="padding:0">
				...
				<div class="well1">
					...
					<div id="side<?=$k;?>" class="repert_d sidebar_date<?php if($k!=1){echo " hidden";}?>">
						...
						<div class="col-xs-8 col-sm-6 col-md-5 col-lg-6"><?php $location = $this->items_model->get_location($i_act['institution']);?><a href="<?=base_url();?>controll/<?=$page_id2;?>/<?=$page_id3;?>/<?=$i_act['id_item_act']?>" class="btn">Проверить билет</a><div class="visible-xs clear" style="margin-top:6px"></div><div class="visible-xs"><a href="<?=base_url();?>view/<?=$page_id2;?>/<?=$page_id3;?>/<?=$i_act['id_item_act']?>" class="btn" style="padding:4px 15px">Купить билет</a></div></div>
						<div class="hidden-xs col-sm-2 col-md-2 col-lg-2"><a href="<?=base_url();?>view/<?=$page_id2;?>/<?=$page_id3;?>/<?=$i_act['id_item_act']?>" class="btn">Купить билет</a></div>
						</div>
