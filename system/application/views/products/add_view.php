...
<select name="id_measure">
<option disabled selected>Выберите ед. измерения</option>
<?php $category = $this->category_model->get_measure(); ?>
<?php foreach($category as $item):?>
<option value="<?=$item['id_measure'];?>"><?=$item['measure'];?></option>
<?php endforeach;?>
</select><br /><br />
...
<option disabled selected>Выберите нижнюю категорию</option>
<?php $category = $this->category_model->get_third_menu(); ?>
<?php foreach($category as $item):?>
<option value="<?=$item['id_menu'];?>"><?=$item['menu'];?></option>
<?php endforeach;?>
</select><br /><br />
<select name="id_specifics">
<option disabled selected>Выберите набор характеристик</option>
<?php $category = $this->specifics_model->get_specific_groups(); ?>
<?php foreach($category as $item):?>
<option value="<?=$item['id_specific'];?>"><?=$item['specific_name'];?></option>
<?php endforeach;?>
</select><br /><br />
