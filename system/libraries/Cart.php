...
class CI_Cart {
	...
	var $product_name_rules	= '\.\:\-_ АаБбВвГгДдЕеЁёЖжЗзИиЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЪъЫыЬьЭэЮюЯяa-zA-Z0-9_[:blank:][:punct:]\»'; // alpha-numeric, dashes, underscores, colons or periods
